...
from flask import render_template,request,Response,make_response,jsonify,abort,redirect,flash,url_for,session
import json
...
def enrollment():
    ...
    courses=course_list(user_id=user_id)
...
@app.route('/index/<numb>')
def bad_request(numb=None):
    if numb != None:
